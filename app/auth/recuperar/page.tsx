...
import { Leaf, Loader2, Mail, AlertCircle, ArrowLeft, Check } from 'lucide-react'
...
export default function RecuperarPage() {
  ...
  async function handleSubmit(e: FormEvent) {
    ...
    const { data: exists, error: checkError } = await supabaseBrowser.rpc('check_email_exists', { p_email: email })

    if (checkError) {
      setError('Error al verificar el email. Intentalo de nuevo.')
      setLoading(false)
      return
    }
      ...
      <div className="min-h-[70vh] flex items-center justify-center py-12">
        <div className="w-full max-w-sm">
          <div className="bg-white border border-stone-200 rounded-3xl p-8 shadow-sm text-center">
            ...
            <h1 className="text-2xl font-black text-stone-900 mb-2">Revisá tu email</h1>
            <p className="text-stone-500 text-sm mb-6">
              Te enviamos un link de recuperación a <strong>{email}</strong>. Revisá tu bandeja de entrada para restablecer tu contraseña.
            </p>
            <Link
              href="/auth/login"
      ...
      <div className="w-full max-w-sm">
        <div className="bg-white border border-stone-200 rounded-3xl p-8 shadow-sm">
          <div className="text-center mb-8">
            ...
            <h1 className="text-2xl font-black text-stone-900">Recuperar Contraseña</h1>
            <p className="text-stone-500 text-sm mt-1">Te enviamos un link a tu email para restablecerla</p>
          </div>
